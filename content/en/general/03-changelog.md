---
title: Memory Diary
description: History of the EgoSMP world and Mace-Exclusive plugin.
order: 3
---
...
- ⚡ Optimized item and GUI loading

### v0.1.1 — Gameplay Improvements
- 🔒 **Crafting Interface** — Limit by recipe type
- ☠️ **Custom Death Messages** — Unique takedown messages
- 👑 **Admin Tier Command** — `/sabi ego set`

### v0.1.0 — Dark Ego & Anti-Farming
- 🌑 **Dark Ego** — Rare drop (5%) from Tier 5+
- 🚫 **Anti-Farming** — Prevent farming Tier 0
- 🛡️ **Ego Protection** — Items protected when dying
...
- 💎 Hunted when owned
- 📍 Strict Mode — cannot put in chest

**Mace of Chaos (The Glitch):**
- 🔮 Corrupted variant with &*%$&$
- ☠️ Cursed when crafted/picked up
- 🎲 20% shuffle opponent's inventory when hitting
- 👻 Name *%&(^* — hide killer identity
