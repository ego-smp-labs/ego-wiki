...
export default function FloatingHub() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 w-14 h-14 bg-[#5865F2] text-white rounded-full shadow-lg shadow-black/50 flex items-center justify-center hover:scale-110 hover:shadow-[#5865F2]/50 transition-all duration-300 z-50 group"
